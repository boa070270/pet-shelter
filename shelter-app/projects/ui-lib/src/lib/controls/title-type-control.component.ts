...
// i18n
const I18N = {
  TITLE_CTRL: [{id: 'b0', lang: 'uk', title: 'Багатомовність'}, {id: 'b0', lang: 'en', title: 'Multi language'}]
};
@Component({
  selector: 'lib-title-type-control',
  template: `
      <lib-boolean-control name="ctl" [titles]="i18NCfg.TITLE_CTRL" [(ngModel)]="ctrl"></lib-boolean-control>
